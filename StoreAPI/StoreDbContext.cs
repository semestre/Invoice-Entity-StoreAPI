...
// this sfile connects the bridge between the cs db and the 
namespace StoreAPI;
...
public class StoreDbContext : DbContext
{
    ...
    public DbSet<Invoice> Invoice { get; set; } // add this first
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) // in here u add the default info
    {
